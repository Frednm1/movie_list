...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget build(BuildContext context) {
    searchPageController = Provider.of<SearchPageController>(context);
    return searchPageController.isLoading
        ? const Center(
              ...
              return Scaffold(
                ...
                body: Column(
                  children: [
                          ...
                          IconButton(
                            onPressed: () {
                              _formKey.currentState!.validate()
                                  ? searchPageController.searchMovies(
                    ...
                    searchPageController.haveError
                        ? const Column(
                            children: [
                              Text('oops something went wrong'),
                            ],
                          )
                        : searchPageController.getSearchedItems.isNotEmpty
                            ? Expanded(
                                child: ListView.builder(
                                  itemCount: searchPageController
                                      .getSearchedItems.length,
